...
import com.example.assignment.fragments.EditUserDetailsFragment;
...
//                .toSortedList(Contact::compareTo)
    ...
    public void  switchToCreateEntryFragment(int id, Serializable serializable, String s){
        FragmentManager manager=getSupportFragmentManager();

        FragmentTransaction transaction=manager.beginTransaction();
        transaction.replace(R.id.fl_show_users, EditUserDetailsFragment.newCreateEntryInstance(id,serializable,s)).addToBackStack("tag")
                .commit();
    }
    public void  switchToViewUserFragment(){
        FragmentManager manager=getSupportFragmentManager();

        FragmentTransaction transaction=manager.beginTransaction();
        transaction.replace(R.id.rl_edit_user, ViewUsersInRecyclerFragment.newInstance())
                .commit();
    }
