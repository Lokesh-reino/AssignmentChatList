...
public class ContactView extends RelativeLayout {
    ...
    protected void onFinishInflate () {
        ...
        photoView = getView(R.id.contact_image_user);
        displayNameView = getView(R.id.contact_name_user);
        phoneNumberView = getView(R.id.contact_number);
    }
    ...
    private void updatePhotoView (Contact contact) {
        ...
        if (photoUri == null) {
            ...
            photoView.setImageURI(Uri.parse(String.valueOf(photoUri)));
    ...
    private void updatePhoneNumberView (Contact contact) {
        if (!contact.getPhoneNumbers().isEmpty()) {
            Set<String> phoneNumber = contact.getPhoneNumbers();//.iterator().next();
            phoneNumberView.setText((CharSequence) phoneNumber);
        }
    }
