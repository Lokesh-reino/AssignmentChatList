...
public class ContactsListViewModel extends AndroidViewModel {
    ...
    public LiveData<Integer> countOfContacts;
    ...
    public int getCountOfContacts() {
        return repository.getCountOfContacts();
    }
        ...
        repository.insertAllContacts(contacts).subscribeOn(Schedulers.io())
                ...
                .subscribe(new CompletableObserver() {
                    ...
                    public void onComplete() {
                        Log.d("Contact Insert","Completed");
                    }
    ...
    public void fetchContactsFromDatabase() {
        ...
        DataSource.Factory<Integer, Contact> size=repository.getAllContacts();
    }
